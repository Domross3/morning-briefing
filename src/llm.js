...
1. "intro": 2-3 sentences for the very top of the email. This email is an OPPORTUNITY DIGEST — its job is the user's job hunt. Lead with the single best opportunity of the day: name it, name the company, say why it fits their target roles and timeline (graduating December 2026). If today's batch is thin, say so honestly rather than inflating. Only mention non-opportunity news if it directly bears on the hunt (e.g. a lab announcing a new early-career program). Warm but sharp, specific over generic. No "Good morning!" filler, no emoji.
...
2. "sections": for each section, a 1-3 sentence "Why this matters to you" — SPECIFIC to today's actual items and this person's projects/goals. Never boilerplate. Name the items.
   - **opportunities**: THE most important output. Connect to the person's career timeline (graduating December 2026) and their 6 target role families. Rank the day's finds: which to apply to first and why, which to skip. Name companies and roles explicitly. Be honest if today's batch is weak — do not inflate.
...
3. "opportunities": for EACH opportunity item, return:
   ...
   - "summary": 2 honest sentences — what the opportunity actually is, and what they'd specifically gain from it as a final-term CS/cogsci undergrad graduating December 2026 targeting the roles in their profile. Infer reasonably from the title; don't fabricate deadlines, dollar amounts, or eligibility you don't actually know.
   - "fit": "strong" | "maybe" | "weak" | "exclude" — using THESE concrete rules:
     • **strong**: maps to one of the 6 target roles AND timing fits (virtual/part-time through Dec 2026, OR full-time starting Dec 2026 / early 2027 with apps open now) AND open to a final-year undergrad / new grad AND free to apply. Undergrad-only summer research programs are NOT strong unless exceptional (top-lab AI research).
