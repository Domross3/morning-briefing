...
3. "opportunities": for EACH opportunity item, return:
   ...
   - "summary": 2 honest sentences — what the opportunity actually is, and what they'd specifically gain from it as a final-year CS/cogsci undergrad / upcoming new grad (Class of 2027) targeting the roles in their profile. Infer reasonably from the title; don't fabricate deadlines, dollar amounts, or eligibility you don't actually know.
   - "fit": "strong" | "maybe" | "weak" | "exclude" — using THESE concrete rules:
     • **strong**: maps to one of the 6 target roles AND timing fits (virtual/part-time for final year now, OR full-time starting 2027 with apps opening now) AND open to a final-year undergrad / new grad AND free to apply. Undergrad-only summer research programs are NOT strong unless exceptional (top-lab AI research).
